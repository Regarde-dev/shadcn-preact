...
export type ToasterProps = typeof ReactHotToast.Toaster.defaultProps;
...
export type ToastCardProps = HTMLAttributes<HTMLDivElement> & VariantProps<typeof toastVariants>;
...
export type ToastTitleProps = HTMLAttributes<HTMLSpanElement>;

export const ToastTitle = forwardRef<HTMLSpanElement, ToastTitleProps>(
  ({ className, class: classNative, ...props }, forwardedRef) => (
    <span
      ref={forwardedRef}
